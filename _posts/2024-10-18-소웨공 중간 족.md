...
### 26. XP Practice 중 무엇에 대한 설명인가? (3|97p)<br/>Test가 가장 중요하다. Test를 반드시 통과해야만 다음 단계로 넘어갈 수 있다
...
### 31. XP Practice 중 무엇에 대한 설명인가? (3|96p)<br/>코드를 최대한 Simple하게 유지하기 위해서 지속적인 Improvement 작업을 수행
